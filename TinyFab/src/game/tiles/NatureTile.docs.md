...
```
Escribe el archivo NatureTile.spec.js y a continuación el archivo NatureTile.js que implementará las pruebas. Las pruebas deben ejecutarse exitosamente. 

Se utiliza Vitest.

La clase NatureTile extenderá la implementación de Tile.js. 
NatureTile.js exporta una clase.
